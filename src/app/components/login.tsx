        ...
        <div className="flex flex-col lg:flex-row w-full h-screen bg-gray-100">
            <div className="hidden lg:flex lg:w-1/2 bg-cover bg-center">
                <div className="flex flex-col items-center justify-center w-full h-full text-black p-10">
                    <h1 className="text-5xl font-bold">Welcome to CHAIRY</h1>
            ...
            <div className="text-center">
                ...
                <p className="mt-4 text-lg">Happy Shopping.</p>
            </div>
            </SignedIn>
            ...
            <p className="text-center mt-4 text-gray-600">New here? <Link href="#" className="txt-red-500 font-bold"> Create an account </Link></p>

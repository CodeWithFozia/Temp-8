    ...
    <nav className="w-full bg-white pt-[14px] pb-[14px]">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between px-4 lg:px-0 ml-3">
        ...
        <div className="hidden md:flex gap-8 ml-3">
          ...
          <Link href={"/components/products"} className="text-[14px] font-medium">
            Shop
          </Link>
          <Link href={"/components/products"} className="text-[14px] font-medium">
            Product
          </Link>
          <Link href={"/components/faq"} className="text-[14px] font-medium">
            Faq
          </Link>
          <Link href={"/components/about"} className="text-[14px] font-medium">
            About
          </Link>
        </div>
